 ...
 * * 
 * UPDATE: Transitioned from local Object Serialization to a persistent MySQL 
 * backend for improved data integrity and concurrent access.
 * 
...
public class UserStore {
    ...
    */
     ...
     * * * VARIABLES:
     * - 'transactionId': A unique string generated using 'System.currentTimeMillis()' 
     * to ensure chronological uniqueness in the audit logs.
     * 
     ...
     * * VARIABLES:
     * - 'transactionId': A unique string generated by prefixing "TR-" to the current 
     * system time in milliseconds to ensure an audit trail.
     * 
